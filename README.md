...
Stanley fährt hoch, monolog von Stanley(vorstellung) --> rauschen (Hackerstimme: "Wir haben ihn übernommen!!")
bis zu einem gewissen Rätsel, behalten Hacker die Macht

danach bekommt sie Stanley wieder

--idee: wir hacken uns immer mehr rein -- zuerst Ton: hören wie leute bsp. passwort ändern; (jm richtet Stanley ein, aber durch rauschen missverstanden-> als hacker interpretiert) --- dann iwann Video: z.B. Leppla gefangen...
